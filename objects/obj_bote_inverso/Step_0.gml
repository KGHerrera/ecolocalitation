...
if place_meeting(x,y, obj_player) and !obj_player.barrel{
	...
	image_angle = scrApproach(image_angle, image_angle_start - 180, 9)
	...
	with (obj_player){
		...
		if other.image_angle == other.image_angle_start - 180 {
			other.wait--
		}
	...
	image_angle = scrApproach(image_angle, image_angle_start, 6)
	wait = wait_shot
